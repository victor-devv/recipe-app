...
<head>
    ...
    <title>{{ config('app.name', 'Garden Recipe App') }}</title>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0" style="min-height: 80vh !important;">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                <h1 class="display-1">GARDEN RECIPE APP</h1>
            </div>

            <div class="flex justify-center pt-8">
                <h6>No Recipes At This Moment</h6>
                <small><a href="{{ route('register') }}">Sign Up To Add Your Recipes</a></small>
            </div>
